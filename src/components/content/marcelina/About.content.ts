...
export const en = {
	...
	paragraphs: [
		...
		'In my everyday work I support entrepreneurs in a complex world of regulations. Solving business challenges through my tax related knowledge is a source of great satisfaction for me. I enjoy contact with my clients, cooperation in problem solving and an individual approach to each and every challenge.'
	]
};
