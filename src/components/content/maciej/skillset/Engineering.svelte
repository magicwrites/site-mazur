...
<div>
	<Percenter value={0.5}>Five parts engineering</Percenter>

	<section class="pt-4 font-work text-gray-400">
		<section class="pb-4 text-sm">
			<div class="text-gray-200 text-xs">Programming languages</div>
			<div>
			...
			<div>Brief experience of .NET technologies, Java and a few other languages.</div>
		</section>

		<section class="pb-4 text-sm">
			<div class="text-gray-200 text-xs">Front-end stack</div>
			<div>
			...
			<div>
				Understanding of modern front-end environment of
		...
		<section class="pb-4 text-sm">
			<div class="text-gray-200 text-xs">Architecture</div>
			<div>
